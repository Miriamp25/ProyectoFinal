...
public class PanGluteo extends AppCompatActivity {

    TextView tvgluteo, tv1, tv2, tv3, tv4, tv5, tv6, tv7;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pan_gluteo);
        tvgluteo=findViewById(R.id.tvgluteo);
